#SOURCES
OBJS= main.cpp Box.cpp Demo.cpp GameState.cpp MenuState.cpp src/*.cpp src/imgui/imgui*cpp
...
LDF= -framework OpenGL -framework SDL2 -framework SDL2_image -framework SDL2_ttf -lSDL2main -lglew -lBox2D
